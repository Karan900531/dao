  ...
  return (
    <div className="pad">
        <div className="chartop">
         {pairData && (
            <>
 <p style={{fontSize:14}}>Total Value Staked</p>
  <p style={{textAlign:'left',fontSize:22,color:'white',fontFamily:'var(--font-medium)'}}>$ {new Intl.NumberFormat("en-US", {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0,
              }).format(Number((totalStakeds + totalStaked)*(pairData.priceUsd)))}{" "}
              </p>
...
<div style={{display:'flex',justifyContent:'space-between'}}>
    <div>
              <p>Special BSC Pool</p>
  <p style={{textAlign:'left',fontSize:14,color:'white',fontFamily:'var(--font-light)'}}>$ {new Intl.NumberFormat("en-US", {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0,
              }).format(Number(totalStaked*pairData.priceUsd))}{" "}
              </p></div>
